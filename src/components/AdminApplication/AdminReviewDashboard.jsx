 ...
 * Allows admins to review and process admin role applications
 */
  ...
  return (
    <div className="admin-review-dashboard">
      <div className="dashboard-header">
        <h1>Admin Application Review Dashboard</h1>
        <p>Review and manage admin role applications</p>
      </div>
              ...
              <div key={app.id} className={`application-card ${app.status}`}>
                <div className="card-header">
                  <div className="applicant-info">
                    ...
                    <p className="role">Current Role: <strong>{app.currentRole}</strong></p>
                  </div>
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <div className="applicant-summary">
                ...
                <p><strong>Current Role:</strong> {reviewingApp.currentRole}</p>
              </div>
